...
export default class WelcomeScreen extends React.Component {
    ...
    userSignUp = (email, password, confirmPassword) => {
        if(password!==confirmPassword){
            ...
            firebase.auth().createUserWithEmailAndPassword(email, password).then((response) => { return alert("User Added Successfully") }).catch(function (error) { var errorcode = error.code; alert(error.message) });
            //IFTTT
        }
    }
